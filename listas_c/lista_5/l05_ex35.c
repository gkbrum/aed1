    ...
    do{
        ...
        switch ( op ) {
            ...
            case 6:
                ...
                if ( num1 != 0 ){   
                    printf( "O caracter ocorre na string S1 %d vezes.\n", num1 );
                } else {
                    printf( "O caracter nao ocorre na string S1.\n" );
                }
                break;
...
void TrocarPrimeiroChar( char *string, char *c1, char *c2 ){
    ...
    if ( pos ){
        *pos = *c2;
        printf( "String S1 após a substituição: %s\n", string );

    } else {
        printf( "O caracter '%c' não esta presente na string S1.\n", *c1 );
    }
}
